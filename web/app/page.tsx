  ...
  return (
    <div className='min-h-screen bg-white'>
      ...
      <section className='mx-auto max-w-6xl px-6 pb-20 pt-24 md:px-12 md:pb-32 md:pt-32 lg:px-16'>
        <h1 className='mb-4 text-5xl font-light tracking-tight text-gray-900 md:text-6xl lg:text-7xl'>
          Milan Bako
        </h1>
        <p className='text-xl font-light text-gray-600 md:text-2xl'>Software Engineer</p>
      </section>
      ...
      <div className='mx-auto max-w-6xl space-y-24 px-6 pb-24 md:space-y-32 md:px-12 lg:px-16'>
        ...
        <List
          ...
          rightElement={<Dropdown selected={limit} options={dropdownOptions} onChange={setLimit} />}
        >
